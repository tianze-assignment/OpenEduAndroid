...
public class SubjectKeyWords {
    public static String[] chinese = {
            "语文", "诗",  "对联", "成语", "方言", "比喻", "拟人", "名言", "作文", "修辞", "小说", "散文",
            "文言文", "人称", "思想", "主题", "情感", "虚词", "介词", "主语", "阅读", "写作", "古今异义",
            "语言风格", "古代诗歌", "文章", "文学体裁", "字形", "句式", "句子", "作家", "熟语",
            "词语", "标点符号", "人物", "字音", "汉字", "注释", "文学", "病句", "词类活用",
            "表达技巧", "常识", "语言"
    };
    public static String[] math = {
            "概率", "方程", "解", "实数", "小数", "几何", "圆", "向量", "空间", "平面", "集合",
            "数论", "函数", "坐标", "微分", "积分", "统计", "质数", "常数", "公式",
            "高斯", "欧拉", "数学家", "关系", "运算", "命题", "概念", "问题", "方法",
            "定义", "单位"
    };
