...
public class EntityInfoActivity extends AppCompatActivity implements WbShareCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(token.equals("-1")){
            ConstraintLayout.LayoutParams params = (ConstraintLayout.LayoutParams) binding.title.getLayoutParams();
            params.endToStart = R.id.imageButtonShare;
            binding.title.setLayoutParams(params);
            binding.imageButtonStar.setVisibility(View.GONE);
        }else{
